                ...
                <BRow>
                  <BCol xl="6">
                    <div>
                      ...
                      <input type="text" v-maska data-maska="['# cm', '#.# cm', '#.## cm']" class="form-control"
                        id="regexp-mask" />
                    ...
                    <div class="mt-4">
                      ...
                      <input type="text" v-maska data-maska="['+1 (###) ##-##-##', '+1 (###) ###-##-##']" class="form-control"
                        id="phone-mask" />
                  ...
                  <BCol xl="6">
                    <div>
                      ...
                      <input type="text" v-maska data-maska="['##/##/####']" class="form-control" id="date-mask" />
                      <div class="text-muted">##/##/####</div>
                    </div>
