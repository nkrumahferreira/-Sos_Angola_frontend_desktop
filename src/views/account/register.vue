...
export default {
  ...
  validations: {
    user: {
      ...
      confirm_password: {
        required: helpers.withMessage("Confirmação da palavra-passe é obrigatória", required),
      },
    },
  },
  computed: {
      ...
      <BContainer>
        ...
        <BRow class="justify-content-center">
          <BCol md="8" lg="6" xl="5">
                ...
                <div class="p-2 mt-4">
                  <form class="needs-validation" @submit.prevent="tryToRegisterIn">
                    ...
                    <div class="mb-3">
                      ...
                      }" id="username" placeholder="Introduza o nome de utilizador">
                    ...
                    <div class="mb-2">
                      <label for="userpassword" class="form-label">Palavra-passe <span class="text-danger">*</span></label>
                      <input type="password" class="form-control" v-model="user.password" :class="{
                        'is-invalid': submitted && v$.user.password.$error,
                      }" id="userpassword" placeholder="Introduza a palavra-passe">
                    ...
                    <div class="mb-2">
                      <label for="userpassword" class="form-label">Confirmar palavra-passe <span
                          class="text-danger">*</span></label>
                      <input type="password" class="form-control" v-model="user.confirm_password" :class="{
                        'is-invalid': submitted && v$.user.password.$error,
                      }" id="userconfirmpassword" placeholder="Confirme a palavra-passe">
                    ...
                    <div class="mb-4">
                      <p class="mb-0 fs-12 text-muted fst-italic">Ao registar concorda com os termos do SOS Angola <BLink
                          href="#" class="text-primary text-decoration-underline fst-normal fw-medium">Termos de utilização
                        </BLink>
                      </p>
                    </div>

                    <div class="mt-4">
                      <BButton variant="success" class="w-100" type="submit">Registar</BButton>
                    </div>
            ...
            <div class="mt-4 text-center">
              <p class="mb-0 text-white">Já tem conta? <router-link to="/login"
                  class="fw-semibold text-decoration-underline ms-1" style="color: #8ab4f8;"> Entrar </router-link>
              </p>
            </div>
          </BCol>
        </BRow>
        ...
        <BRow>
          <BCol lg="12">
            <div class="text-center">
              <p class="mb-0 text-muted">&copy; {{ new Date().getFullYear() }} SOS Angola — Área das Autoridades.</p>
            </div>
          </BCol>
        </BRow>
      </BContainer>
