          ...
          <BCol md="8" lg="6" xl="5">
            <BCard no-body class="mt-4">
              <BCardBody class="p-4">
                <div class="text-center mt-2">
                  <h5 class="text-primary">Esqueceu a palavra-passe?</h5>
                  <p class="text-muted">Recupere a palavra-passe com SOS Angola</p>
                  ...
                  <form @submit.prevent="tryToReset">
                    <div class="mb-4">
                      ...
                      <input type="email" v-model="email" class="form-control" id="email"
                        :class="{ 'is-invalid': submitted && v$.email.$errors }" placeholder="Introduza o e-mail" />
            ...
            <div class="mt-4 text-center">
              <p class="mb-0 text-white">
                Lembro-me da palavra-passe.
                <router-link to="/login" class="fw-semibold text-decoration-underline ms-1" style="color: #8ab4f8;">
                  Entrar
                </router-link>
              </p>
            </div>
